...
public class ImageStorageServiceImpl implements IStorageService{
    ...
    public String storeFile(MultipartFile file) {
        try{
            ...
            if (fileSize > 5.0f){
                throw new RuntimeException("You can only upload image with size <= 5Mb.");
            }
...
//            if (!destinationFilePath.getParent().endsWith(this.storageFolder.toAbsolutePath())){
//                throw new RuntimeException("Cannot store size outside current directory.");
//            }
